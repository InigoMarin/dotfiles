...
globalkeys = my_table.join(
    ...
    {description = "show rofi drun", group = "hotkeys"}),
    ...
    awful.key({ modkey }, "e",     function () awful.spawn(terminal .. " -e lf") end ,
              {description = "run lf", group = "hotkeys"}),

    awful.key({ modkey  }, "s", function () awful.util.spawn( "./.dmenu/dmenu-surfraw.sh" ) end,
	{description = "surfraw web search" , group = "hotkeys" }),
	...
	awful.key({ modkey }, "c",     function () awful.spawn("google-chrome") end ,
              {description = "run google-chrome", group = "hotkeys"}),
	
	awful.key({ modkey, "Shift"}, "b",     function () awful.spawn("brave-browser-stable") end ,
              {description = "run brave", group = "hotkeys"}),
	
	awful.key({ modkey, "Shift"}, "c",     function () awful.spawn("qutebrowser") end ,
              {description = "run qutebrowser", group = "hotkeys"}),
	-- ncmpcpp 
	...
	awful.key({ modkey }, "F3",     function () awful.spawn("displayselect") end ,
              {description = "displayselect", group = "launcher"}),
	awful.key({ modkey }, "F4",     function () awful.spawn(terminal .. " -e pulsemixer") end ,
              {description = "run pulsemixer", group = "launcher"}),
	
	awful.key({ modkey }, "F6",     function () awful.spawn("torwrap") end ,
              {description = "run torwrap", group = "launcher"}),
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("maimpick") end,
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- Dynamic tagging
    awful.key({ modkey, "Control" }, "c", function () lain.util.add_tag() end,
              {description = "add new tag", group = "tag"}),
    awful.key({ modkey, "Control" }, ",", function () lain.util.rename_tag() end,
