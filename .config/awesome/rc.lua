...
globalkeys = gears.table.join(
	...
	awful.key({ modkey,           }, "w", function () awful.spawn("dswitcher") end,
              {description = "switch window", group = "screen"}),
    ...
    awful.key({ modkey }, "e",     function () awful.spawn(terminal .. " -e lf") end ,
              {description = "run lf", group = "launcher"}),

    awful.key({ modkey }, "c",     function () awful.spawn("brave-browser-stable") end ,
              {description = "run brave-browser-stable", group = "launcher"}),
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("pamixer --allow-boost -i 5") end),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("pamixer --allow-boost -d 5") end),
